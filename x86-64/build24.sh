...
# 修复点1: 删除 luci-i18n-openclash-zh-cn 行
...
# 修复点2 & 3: 删除 kmod-sched-core, kmod-sched-htb, kmod-sched-fq-codel，替换为 kmod-sched
PACKAGES="$PACKAGES kmod-sched"           # 完整的TC调度模块集 (HTB, fq_codel等)
